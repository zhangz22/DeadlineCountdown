...
/*
 * This code is from https://stackoverflow.com/questions/16373459/java-jscrollbar-design
 */
...
public class ModernScrollPane extends JScrollPane {
    ...
    private static Color THUMB_COLOR = Color.WHITE;
    ...
    private static class ModernScrollBarUI extends BasicScrollBarUI {
        ...
        ModernScrollBarUI(ModernScrollPane sp) {
            this.sp = sp;
        }
